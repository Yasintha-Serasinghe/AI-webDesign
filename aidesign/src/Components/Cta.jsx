...
export default function Cta() { //last section 
  return (
    <div className="">
      ...
      <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 m-10 lg:ml-24 items-center justify-center ">
        <div>
          ...
          >
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400">
              {" "}
              'Create an image of a tranquil forest scene with a flowing stream,
              lush greenery, and a warm, golden sunset.'
            </p>
        ...
        <div>
          ...
          >
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400">
              Envision the Irish fairy queen, the Tuatha Dé Danann's Queen Medb,
              ruling over her mystical realm
            </p>
        ...
        <div>
          ...
          >
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400">
              Imagine an astronaut floating in the vastness of space, gazing at
              a beautiful cosmic phenomenon
            </p>
